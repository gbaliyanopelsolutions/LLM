...
const uploadDirs = {
	logos: path.join(__dirname, 'public', 'uploads', 'company-logos'),
	banners: path.join(__dirname, 'public', 'uploads', 'company-banners'),
};
...
app.use('/api/builder', createSurveyBuilderRouter({ anthropic, model, upload }));
