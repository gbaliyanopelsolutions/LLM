...
export default function AddCompanyPage() {
	useEffect(() => {
		...
		// Dynamically load the company.js script
		const companyScript = document.createElement('script');
		companyScript.type = 'module';
		companyScript.src = '/company.js';
		document.body.appendChild(companyScript);

		return () => {
			if (document.head.contains(sidebarScript)) {
				document.head.removeChild(sidebarScript);
			}
			if (document.body.contains(companyScript)) {
				document.body.removeChild(companyScript);
			}
		};
	}, []);
	...
	return (
		<>
			...
			<div className="dash-shell">
				{/* Sidebar Component */}
				<dashboard-sidebar current-page="add-company"></dashboard-sidebar>
				...
				<div className="dash-content">
					<div className="dash-topbar">
						<div className="dash-topbar__left">
							...
							<div>
								...
								<p className="dash-topbar__sub">Register and manage companies</p>
							</div>
						</div>
					...
					<div className="dash-page">
						<div className="dash-page-header">
							<div>
								<h1>Add Company</h1>
								<p>Register a company to associate with your surveys.</p>
							</div>
						</div>
						...
						>
							...
							<p className="lead">Name and tier are required. Branding fields are optional.</p>
									...
									<div className="form-grid">
										<div className="field form-grid__full">
											<label htmlFor="company-name">
												Company name <span className="req-label">*</span>
											</label>
											<input
												className="dsi-input"
												type="text"
										...
										<div className="field form-grid__full">
											<label htmlFor="company-tier">
												Tier <span className="req-label">*</span>
											</label>
									...
									<div className="form-grid">
										<div className="field form-grid__full">
											...
											<div className="file-upload-wrapper">
												<input
													...
													data-type="logo"
												/>
												<button type="button" className="dsi-btn dsi-btn--ghost" id="logo-btn" style={{ width: '100%' }}>
													Upload Logo
												</button>
										...
										<div className="field form-grid__full">
											...
											<div className="file-upload-wrapper">
												<input
													...
													data-type="banner"
												/>
												<button type="button" className="dsi-btn dsi-btn--ghost" id="banner-btn" style={{ width: '100%' }}>
													Upload Banner
												</button>
										...
										<div className="field">
											...
											<div className="color-input-wrapper">
												...
												<span id="bg-color-text" className="color-text">
													#ffffff
												</span>
											</div>
										</div>
										...
										<div className="field">
											...
											<div className="color-input-wrapper">
												...
												<span id="text-color-text" className="color-text">
													#000000
												</span>
											</div>
										</div>
