...
STYLE — read ONLY the user's instructions (not the document) for visual requirements:
- "background color #xyz" or "bg #xyz"  → style.backgroundColor = "#xyz"
- "text color #xyz" or "color #xyz" or "font color #xyz" → style.textColor = "#xyz"
- "accent color #xyz" or "button color #xyz" → style.accentColor = "#xyz"
- "logo" + a URL that contains http  → style.logoUrl = that URL exactly
- "card background #xyz" → style.cardColor = "#xyz"
Only include style fields that are EXPLICITLY mentioned in the REQUIREMENTS section. Do NOT invent colors.

STYLE EXAMPLE — for requirements: "background color #999, font color #fff, add logo https://example.com/logo.png"
