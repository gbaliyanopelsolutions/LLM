...
Accepted formats for each property:
  backgroundColor: "background color #xyz" OR "bg #xyz" OR "backgroundColor: '#xyz'" OR "backgroundColor: #xyz"
  textColor: "text color #xyz" OR "font color #xyz" OR "textColor: '#xyz'" OR "fontColor: '#xyz'"
  accentColor: "accent color #xyz" OR "accentColor: '#xyz'"
  logoUrl: "logo ... https://..." OR "logoUrl: 'https://...'" OR "logo image url https://..."
