...
class DashboardSidebar extends HTMLElement {
	...
	render(currentPage) {
		let navItems = [
			...
			{ href: '/surveys', label: 'Survey Analytics', page: 'surveys', section: 'Manage', icon: 'analytics', badge: 'New' },
			{ href: '/add-company', label: 'Companies', page: 'add-company', section: 'Manage', icon: 'companies' },
			{ href: '/analytics', label: 'Analytics', page: 'analytics', section: 'Manage', icon: 'analytics' },
		];
